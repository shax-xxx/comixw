...
HOST=comixwall
RRD=/var/www/htdocs/comixwall/View/pmacct/protograph/${HOST}.rrd
IMAGE_NAME=/var/www/htdocs/comixwall/View/pmacct/protograph/${HOST}-hourly.gif
DURATION=3600

/usr/local/bin/rrdtool graph /var/www/htdocs/comixwall/View/pmacct/protograph/comixwall-hourly.gif --start -3600 -v "bits per second" -F -t "Overall Protocol (Port) Usage" \
  DEF:alltraf=/var/www/htdocs/comixwall/View/pmacct/protograph/comixwall.rrd:all:AVERAGE \
