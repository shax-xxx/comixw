...
# $ComixWall: pnrg.pl,v 1.3 2009/09/03 09:30:19 soner Exp $
...
my $rrd_create = '/var/www/htdocs/comixwall/View/pmacct/pnrg/pnrg-create.pl';
my $rrd_update = '/var/www/htdocs/comixwall/View/pmacct/pnrg/pnrg-update.pl';
